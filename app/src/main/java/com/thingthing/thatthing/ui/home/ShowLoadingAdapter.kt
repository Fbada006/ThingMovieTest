...
import com.thingthing.thatthing.databinding.ItemLoadingStateBinding

class ShowLoadingAdapter(private val retry: () -> Unit) :
    LoadStateAdapter<ShowLoadingAdapter.LoadingStateViewHolder>() {
